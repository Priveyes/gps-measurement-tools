...
public class FileLogger implements GnssListener {
	...
	public void startNewLog() {
		synchronized (mFileLock) {
			...
			SimpleDateFormat formatter = new SimpleDateFormat("yyy_MM_dd_HH_mm_ss", Locale.getDefault());
			Date now = new Date();
	...
	public void onLocationChanged(Location location) {
		if (location.getProvider().equals(LocationManager.GPS_PROVIDER)) {
			synchronized (mFileLock) {
				...
				String locationStream = String.format(Locale.US, "Fix,%s,%f,%f,%f,%f,%f,%d", location.getProvider(), location.getLatitude(), location.getLongitude(), location.getAltitude(), location.getSpeed(), location.getAccuracy(), location.getTime());
				try {
