...
public class AgnssFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		clearAgps.setOnClickListener(view -> {
		...
		fetchExtraData.setOnClickListener(view -> {
		...
		fetchTimeData.setOnClickListener(view -> {
		...
		requestSingleNlp.setOnClickListener(view -> {
		...
		requestSingleGps.setOnClickListener(view -> {
