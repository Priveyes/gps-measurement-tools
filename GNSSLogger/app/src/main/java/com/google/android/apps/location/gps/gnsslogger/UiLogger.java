...
public class UiLogger implements GnssListener {
	...
	public void onLocationStatusChanged(String provider, int status, Bundle extras) {
		String message = String.format("onStatusChanged: provider=%s, status=%s, extras=%s", provider, locationStatusToString(status), extras);
	...
	public void onNmeaReceived(long timestamp, String s) {
		logNmeaEvent(String.format(Locale.getDefault(), "onNmeaReceived: timestamp=%d, %s", timestamp, s));
	}
