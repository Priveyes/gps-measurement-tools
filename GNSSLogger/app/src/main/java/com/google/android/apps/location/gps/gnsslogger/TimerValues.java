...
public class TimerValues {
	...
	public TimerValues(long milliseconds) {
		this(0 /* hours */, 0 /* minutes */, (int) TimeUnit.SECONDS.convert(milliseconds, TimeUnit.MILLISECONDS));
	}
	...
	public long getTotalMilliseconds() {
		return (TimeUnit.MILLISECONDS.convert(mHours, TimeUnit.HOURS) + TimeUnit.MILLISECONDS.convert(mMinutes, TimeUnit.MINUTES) + TimeUnit.MILLISECONDS.convert(mSeconds, TimeUnit.SECONDS));
	}
	...
	public String toCountdownString() {
		return String.format(Locale.getDefault(), "%02d:%02d:%02d", mHours, mMinutes, mSeconds);
	}
